...
typedef  EdsBaseRef    EdsFlashRef;
...
#define kEdsPropID_IBIS_HighResoShot	  0x000004e0
#define kEdsPropID_StillFileNameSetting   0x000004e1 
#define kEdsPropID_StillFileNameUserSet1  0x000004e2 
#define kEdsPropID_StillFileNameUserSet2  0x000004e3 
#define kEdsPropID_StillFolderName        0x000004e4 
#define kEdsPropID_MovieFileNameIndex     0x000004e5 
#define kEdsPropID_MovieFileNameReelNo    0x000004e6 
#define kEdsPropID_MovieFileNameClipNo    0x000004e7 
#define kEdsPropID_MovieFileNameUserDef   0x000004e8
...
#define kEdsPropID_Evf_FocalLength         0x01000555
#define kEdsPropID_MovieRecVolume_IntMic   0x01000489
#define kEdsPropID_MovieRecVolume_ExtMic   0x0100048a
#define kEdsPropID_MovieRecVolume_Acc      0x0100048b
#define kEdsPropID_MovieParamEx            0x011004c6
#define kEdsPropID_SlowFastMode            0x010004c7 

/*----------------------------------
 Flash Properties
----------------------------------*/
#define kEdsPropID_Flash_Firing            0x0000200d
#define kEdsPropID_Flash_Target            0x0000201e
...
#define kEdsPropertyEvent_PropertyDescExChanged     0x00000110
...
/*-----------------------------------------------------------------------------
 Property Desc 64
-----------------------------------------------------------------------------*/
typedef struct tagEdsPropertyDescEx
{
    EdsInt32        form;
    EdsInt32		access;
    EdsInt32        numElements;
    EdsInt64        propDesc[2048];
...
/*-----------------------------------------------------------------------------
 ApertureLockSetting
-----------------------------------------------------------------------------*/
typedef struct tagEdsApertureLockSetting
{
    EdsUInt32       apertureLockStatus;
    EdsUInt32       avValue;
} EdsApertureLockSetting;

/*---------------------------------------------------
 MovieFileNoSet
--------------------------------------------------*/
typedef struct tagEdsMovieFileNoSet
{
    EdsUInt16    number;
    EdsUInt16    reserve;
} EdsMovieFileNoSet;
